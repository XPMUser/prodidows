...
class ModHandler {
		...
		PlayerContainer.prototype.setup = function() {
			if (Util.isDefined(this.assets)) {
				...
				var a = this.assets[0],
					...
					p = -h[3];
				if (null !== s && (this.face = new Sprite(this.game, l - (h[0] - (1 != this.setScale ? 93 : 44)), p - (h[1] - (1 != this.setScale ? 82 : 48)), "heads2", s), this.face.inputEnabled = !0, this.face.events.onInputDown.add(this.playerClicked.bind(this)), this.sprites.add(this.face), this.faceY = this.face.y), null !== r && (this.eyes = new Sprite(this.game, l - (h[0] - (1 != this.setScale ? 113 : 55)), p - (h[1] - (1 != this.setScale ? 114 : 65)), "heads", r), this.sprites.add(this.eyes), this.eyesY = this.eyes.y), null !== i) {
	...
	initClassicFacesForBoysMod() {
		...
		assets.heads.base = "https://daboss7173.github.io/oldprodigy/1-10-0/assets/images/general-head";
